...
Calendar.prototype = {
    ...
    init: function () {
       ...
       // opts.width = el.width();
        ...
        el.on("click", ".calendar-cell", function (e) {
            ...
            var month = parseInt(cellDate.split("-")[1].split("-")[0]) - 1;
            var date = parseInt(cellDate.split("-")[1].split("-")[1]);
    ...
    _refreshCalendar: function (newDate,cycleData) {
        ...
        var nowNumM = _newDate.getMonth() + 1;
        var week=[6,0];
        //第一天周几
        _newDate.setDate(1);
        ...
        for (var i = 0; i < 6; i++) {
            ...
            for (var l = 0; l < 7; l++) {
                ...
                if (renderDate.getMonth() < newDate.getMonth()) {
                    ...
                    s += '<td title="' + year + '-' + month + '-' + date + '" class="calendar-cell-past">';
                } else if (date == nowNum && nowNumM == m) {
                    if (day==week[0] || day==week[1]) {
                        s += '<td title="' + year + '-' + month + '-' + date + '" class="calendar-cell calendar-weekend calendar-today">';
                    } else {
                        s += '<td title="' + year + '-' + month + '-' + date + '" class="calendar-cell calendar-today">';
                    }
                } else if (date < nowNum && nowNumM == m) {
                    if (day==week[0] || day==week[1]) {
                        s += '<td title="' + year + '-' + month + '-' + date + '" class="calendar-cell-past calendar-weekend">';
                    } else {
                        s += '<td title="' + year + '-' + month + '-' + date + '" class="calendar-cell-past">';
                    }
                } else if(day==week[0] || day==week[1]){
                        s += '<td title="' + year + '-' + month + '-' + date + '" class="calendar-cell calendar-weekend">';  
                }
                else {
