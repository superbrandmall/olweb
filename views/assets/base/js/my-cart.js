...
<h3 class="c-font-uppercase c-font-bold c-theme-bg c-font-white c-cart-item-title c-cart-item-first hidden-lg hidden-md" style="float: left;">店铺'+index+'</h3>\n\
...
<p class="c-cart-sub-title c-theme-font c-font-uppercase c-font-bold hidden-lg hidden-md">商业项目</p>\n\
<p>正大广场陆家嘴购物中心</p></div>\n\
...
<a href="javascript:;" class="remove-cart c-cart-remove-mobile btn c-btn c-btn-md c-btn-square c-btn-red c-btn-border-1x c-font-uppercase hidden-lg hidden-md">从购物车里删除</a></div>\n\
</div>');                            

                    });
                } else {
                    $('.table-rows').append('<div class="row c-cart-table-row"><div class="col-md-12">购物车目前为空</div></div>');
                }
            } else {
...
<div class="c-overlay-content"><a href="shop?id='+v.code+'" class="btn btn-md c-btn-grey-1 c-btn-uppercase c-btn-bold c-btn-border-1x c-btn-square">查看详情</a></div></div>\n\
<div class="c-bg-img-center-contain c-overlay-object" data-height="height" style="height: 270px; background-size: 405px; background-image: url('+img+');"></div></div>\n\
...
<div class="btn-group btn-group-justified" role="group"><div class="btn-group c-border-top" role="group"><a href="shop?id='+v.code+'" class="btn btn-lg c-btn-white c-btn-uppercase c-btn-square c-font-grey-3 c-font-white-hover c-bg-red-2-hover c-btn-product">查看详情</a></div></div></div></div>');
                    })
                }
