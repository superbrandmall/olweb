var index=0;
var unitCodes = ["2F-44B","4F-37","4F-38","6F-24"];
var vr;
...
function renderShopList(s){
    ...
    $.each(shop, function(j,w){
        if(w.state == 1){
            ...
            $('#empty_stores').append('<a id="shop_'+w.unitCode+'" href="/v2/shop?id='+w.remarkSecond+'&type=leasing&storeCode=OLMALL190117000001" class="weui-grid">\n\
                <div class="weui-grid__icon" style="position: relative;">\n\
                    ...
                    <img src="/views/assets/base/img/content/backgrounds/ly/Floor/0'+w.floor+'.png" alt="0'+w.floor+'" height="35" style="position: absolute;bottom: 29px;right: 11px;width: 73px;height: auto;">\n\
            ...
            if(response.code === 'C0') {
                $.each(response.data, function(i,v){
                    if(v.state !== 0 && v.coords != null && v.coords != ''){
                        ...
                        if(index >= 0){
                            $('map').append('<area data-key="'+v.unit+'" alt="'+v.code+'" data-full="'+v.shopState+'" data-area="'+v.area+'" data-logo="'+v.logo+'"  href="/v2/shop?id='+v.code+'&type=leasing&storeCode=OLMALL190117000001" shape="poly" coords="'+v.coords+'" />');
                        } else {
