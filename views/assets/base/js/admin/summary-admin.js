...
$(document).ready(function(){
    ...
    $('#summary_area tbody').append('<tr><td>合计</td><td style="background: #dff0d8;">'+stores_0_total+'m<sup>2</sup></td><td style="background: #ebcccc;">'+stores_1_total+'m<sup>2</sup></td><td style="background: #faf2cc;">'+stores_2_total+'m<sup>2</sup></td><td style="background: #D5C8AA;">'+stores_3_total+'m<sup>2</sup></td><td>'+stores_total+'m<sup>2</sup></td></tr>');
    ...
    $('#summary_units tbody').append('<tr><td>合计</td><td style="background: #dff0d8;">'+stores_0_units_total+'个</td><td style="background: #ebcccc;">'+stores_1_units_total+'个</td><td style="background: #faf2cc;">'+stores_2_units_total+'个</td><td style="background: #D5C8AA;">'+stores_3_units_total+'个</td><td>'+stores_units_total+'个</td></tr>');
    ...
    $.ajax({
        ...
        success: function (response, status, xhr) {
            if(response.code === 'C0') {
                ...
                $('#summary_area_percentage tbody').append('<tr><td>'+fl+'</td><td style="background: #dff0d8;">'+leased+'%</td><td style="background: #ebcccc;">'+empty+'%</td><td style="background: #faf2cc;">'+toBeLeased+'%</td><td style="background: #D5C8AA;">'+renovation+'%</td></tr>');
                ...
                $('#summary_units_percentage tbody').append('<tr><td>'+fl+'</td><td style="background: #dff0d8;">'+leased_units+'%</td><td style="background: #ebcccc;">'+empty_units+'%</td><td style="background: #faf2cc;">'+toBeLeased_units+'%</td><td style="background: #D5C8AA;">'+renovation_units+'%</td></tr>');
