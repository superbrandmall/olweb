                    ...
                    $.each(response.data, function(i,v){
                        if(v.remarkSecond == 'advertising'){
                            ...
                            $.each(v.contractTermInfos, function(j,w){
                                ...
                                $('.page__bd').append('<div class="weui-panel" style="background-color: #292929; margin-top: 0;">\n\
            <div class="weui-panel__hd" style="color: #bba585;">\n\
                '+w.name+'\n\
            </div>\n\
            <div class="weui-panel__bd" style="background-color: #3f3f3f;">\n\
                <div class="weui-media-box weui-media-box_appmsg weui-cells weui-cells_checkbox" style="background-color: #3f3f3f; padding-top: 0; padding-bottom: 0; margin-top: 0;">\n\
                    ...
                    <div class="weui-media-box__bd">\n\
                        <div class="weui-form-preview__bd" style="font-size: 15px;">\n\
                            <div class="weui-form-preview__item">\n\
                                <span class="weui-form-preview__value" style="text-align: left; color: #bba585;">'+type+'</span>\n\
                                <span class="weui-form-preview__value">\n\
                                    <div class="weui-cell__bd">\n\
                                        <input class="weui-input date-start" id="dateStart_'+w.remarkFirst+'" placeholder="填写档期起始日" style="color: #bba585;" readonly>\n\
                                    </div>\n\
                                </span>\n\
                                <span class="weui-form-preview__value">\n\
                                    <div class="weui-cell__bd">\n\
                                        <input class="weui-input date-end" id="dateEnd_'+w.remarkFirst+'" placeholder="填写档期终止日" style="color: #bba585;" readonly>\n\
                                    </div>\n\
                                </span>\n\
                            </div>\n\
                        </div>\n\
                ...
                <div class="weui-cell" style="color: #bba585;">\n\
                    ...
                    <div class="weui-cell__ft">\n\
                        <div class="weui-count">\n\
                            <a class="weui-count__btn weui-count__decrease" style="border: solid 1px #bba585; border-radius: 6px; width: 18px; height: 18px;"></a>\n\
                            <input id="qty_'+w.unitCode+'" class="weui-count__number" type="number" value="1" style="color: #bba585;" min="0" max="'+quantity+'" readonly />\n\
                            <a class="weui-count__btn weui-count__increase" style="border: solid 1px #bba585; background: transparent; border-radius: 6px; width: 18px; height: 18px;'+style+'"></a>\n\
                        </div>\n\
                    </div>\n\
                </div>\n\
            </div>\n\
    ...
    $.ajax({
        ...
        success: function (response, status, xhr) {
            if(response.code === 'C0') {
                ...
                window.location.href = '/v2/contract?type=ads&id='+getURLParameter('id');
            } else {
                interpretBusinessCode(response.customerMessage);
            }
        },
