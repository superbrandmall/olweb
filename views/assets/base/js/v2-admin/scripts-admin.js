...
function searchShopAndCheck(){
    ...
    <div class="panel-body"><div class="list-group" id="list_group_'+i+'"></div></div></div></div></div>');
                    $.each(v, function(j,w) {
                        if(w.subType == '正柜' || w.subType == 'kiosk'){
...
function generatePages(currentPage, LastPage) {
    ...
    if (LastPage <= 6) {
        ...
        if(currentPage>1){
            ...
            pages += '<li><a href="?page='+previousPage+'" aria-label="上一页"><span aria-hidden="true">&laquo;</span></a></li>';
        } else {
            pages += '<li><span aria-hidden="true">&laquo;</span></li>';
        }
        for(var i=1;i<=3;i++) {
            if(i == currentPage ) {
                pages += '<li class="active"><a href="javascript: void(0);">'+i+'</a></li>';
        ...
        pages += '<li><span aria-hidden="true">...</span></li>';
        ...
        if(currentPage<LastPage){
            ...
            pages += '<li><a href="?page='+nextPage+'" aria-label="下一页"><span aria-hidden="true">&raquo;</span></a></li>';
        } else {
            pages += '<li><span aria-hidden="true">&raquo;</span></li>';
        }
    }
