$(document).ready(function(){
    $('#tab_pay_first_options input').each(function(i,elem){
        if ($(elem).prop("checked")) {
            $(elem).parent().removeClass('btn-default').addClass('btn-info');
        }
        ...
        $(elem).click(function () {
            if ($(this).prop("checked")) {
                ...
                $(elem).parent().removeClass('btn-info').addClass('btn-default');
            }
        })
    })
