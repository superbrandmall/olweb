            ...
            if(response.code === 'C0') {
                ...
                if(response.data.content.length > 0) { 
                    ...
                    $.each(response.data.content, function(i,v){
                        var contractLink = '';
                        if(v.oldContractInfo != null){
                            contractLink = '<a href="/lotus-admin/contract-summary?id='+v.oldContractInfo.contractNo+'&contractVersion='+v.oldContractInfo.contractVersion+'" target="_blank">'+v.oldContractInfo.contractNo+'</a>';
                        }
                        ...
                        $('#requests').append('\
                            <tr data-index="'+i+'">\n\
                            <td style="background: '+tbg+'; z-index: 1; border-right: solid 2px #ddd;"><a href="/lotus-admin/terminate-summary?id='+v.bizId+main+'">'+v.bizId+'</a></td>\n\
                    ...
                    $('#requests').html('<tr><td colspan="13" style="text-align: center;">没有找到任何记录！</td></tr>');
                }
            } else {
