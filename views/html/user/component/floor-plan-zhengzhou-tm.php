...
<div class="col-md-12">
    <center>
        <img src="views/assets/base/img/content/floor-plan/zhengzhou-tm/<?= $i ?>F.png" class="img-responsive" alt="<?= $i>0 ? $i : 'B1' ?>F" usemap="#Map_<?= $i ?>F" />
...
<script>
    ...
    function drawShops(){
        ...
        $('#floor_map_F_zhengzhou').find('img').mapster({
            fillColor: 'c34343',
            fillOpacity: 0.8,
            strokeColor: 'ffd62c',
            strokeWidth: 0,
        ...
        $('#floor_map_F_zhengzhou img[usemap]').mapster('resize', 0.65*($(window).width()), 0, 0);
    }
</script>