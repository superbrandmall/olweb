...
<div style="margin: 50px 50px 20px; color: #6d6d73;">
    ...
    <span style="margin-left: 15px; background: url(views/assets/base/img/content/floor-plan/sprite.png); background-size: 238px; background-position: -59px 0; vertical-align: bottom; height: 30px; width: 30px; display: inline-block;"></span> 停车场
    ...
    <span style="margin-left: 15px; background: url(views/assets/base/img/content/floor-plan/sprite.png); background-size: 238px; background-position: -179px 0; vertical-align: bottom; height: 30px; width: 30px; display: inline-block;"></span> 上楼
