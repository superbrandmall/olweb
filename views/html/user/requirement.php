								...
								<div class="form-group">
                                    ...
                                    <div style="float: left; margin-right: 20px;">
                                        <div class="c-checkbox">
                                            ...
                                            <label for="<?= $wx_tm ?>" class="c-font-thin c-font-16">
                                            <span></span>
                                            <span class="check"></span>
                                            <span class="box"></span>
                    ...
                    <!--<div class="col-md-8">
                        <div class="c-content-testimonial-2-slider" data-slider="owl" data-single-item="true" data-auto-play="6000" style="margin-bottom: 30px;">
                            <div class="owl-carousel owl-theme c-theme owl-single">
                                <div class="item">
                                    <div class="c-content-testimonial-2 c-bg-white c-no-border c-shadow" style="background-image:url(views/assets/base/img/content/misc/feedback_box_3.png); background-position: right bottom; background-repeat: no-repeat; padding: 30px;">
                        ...
                        <div class="c-content-testimonial-2-slider" data-slider="owl" data-single-item="true" data-auto-play="6000">
                            <div class="owl-carousel owl-theme c-theme owl-single">
                                <div class="item">
                                    <div class="c-content-testimonial-2 c-bg-white c-no-border c-shadow" style="min-height: 360px; background-image:url(views/assets/base/img/content/misc/feedback_box_3.png); background-position: right bottom; background-repeat: no-repeat; padding: 30px;">
                                        <div class="c-content-title-1 c-inverse">
