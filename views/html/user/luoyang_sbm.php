                    ...
                    <div class="col-md-6">
                        <div class="c-content-title-1">
                            ...
                            <ul class="c-content-list-1 c-theme c-separator-dot c-square">
                                <li class="c-bg-before-red"><?= $lang['mall_ly_lee_royal_hotel'] ?> <small><?= $lang['mall_ly_lee_royal_hotel_addr'] ?></small></li>
                                <li class="c-bg-before-red"><?= $lang['mall_ly_dongshan_hotel'] ?> <small><?= $lang['mall_ly_dongshan_hotel_addr'] ?></small></li>
                                <li class="c-bg-before-red"><?= $lang['mall_ly_yading_peninsula_hotel'] ?> <small><?= $lang['mall_ly_yading_peninsula_hotel_addr'] ?></small></li>
                            </ul>
                        </div>
                    </div>
                </div>
