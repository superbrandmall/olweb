<?php
$scripts = $scripts. '<script type="text/javascript" src="views/assets/base/js/add-brand.js"></script>'
    . '<script type="text/javascript" src="views/assets/plugins/typeahead/typeahead.bundle.js"></script>';
?>
					...
					<div class="container">
                        <form id="add_brand_form">
                            <div class="c-content-title-1">
                                <h3 class="c-center c-font-uppercase c-font-bold">添加品牌</h3>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="brand_name" name="brand_name" placeholder="品牌名称*" class="form-control input-lg c-square" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>品牌属性*</label>
                                        <select id="attribute" name="attribute" class="form-control input-lg c-square" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="file" id="logo" name="logo" class="form-control input-lg c-square" required>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="hidden" name="MAX_FILE_SIZE" value="9000000">
                                        <input type="hidden" id="hidden_brand_author">
                                        <label>品牌授权书* (接受图片格式为jpg,jpeg,png)</label>
                                        <input type="file" id="brand_author" name="brand_author" class="form-control input-lg c-square" required>
                                        <div id="errorcontainer-brand_author" class="errorDiv"></div>
                                    </div>
                                </div>    
                                <div class="clearfix"> </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" name="MAX_FILE_SIZE" value="9000000">
                                        <input type="file" id="shop_sample" name="shop_sample" class="form-control input-lg c-square" multiple required>
                                        <div id="errorcontainer-shop_sample" class="errorDiv"></div>
                                    </div>
                                </div>    
                                <div class="clearfix"> </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="modality_1">一级业态*</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="modality_2">二级业态*</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="modality_3">三级业态*</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>品牌价位*</label>
                                        <select id="class" name="class" class="form-control input-lg c-square" required>
                                            <option value="">请选择 (必选)</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>口碑*</label>
                                        <select id="reputation" name="reputation" class="form-control input-lg c-square" required>
                                            <option value="">请选择 (必选)</option>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>市场销售份额*</label>
                                        <input type="text" id="market_share" name="market_share" placeholder="必填" class="form-control input-lg c-square" required>
                                        ...
                                        <div class="panel-body c-font-18" style="padding: 0;">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="name_eng" name="name_eng" placeholder="英文名称" class="form-control input-lg c-square">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control input-lg c-square" id="location" name="location">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control input-lg c-square" id="standard_area" name="standard_area">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control input-lg c-square" id="target" name="target">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="city" name="city" placeholder="城市" class="form-control input-lg c-square">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control input-lg c-square" id="history" name="history">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="rank" name="rank" placeholder="行业排名" class="form-control input-lg c-square">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control input-lg c-square" id="shop_amount" name="shop_amount">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control input-lg c-square" id="compare" name="compare">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="average_unit_price" name="average_unit_price" placeholder="客单价" class="form-control input-lg c-square">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control input-lg c-square" id="joined" name="joined">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control input-lg c-square" id="join_other_mall" name="join_other_mall">
