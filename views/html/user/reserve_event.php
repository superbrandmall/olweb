	...
	<div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold">
		<div class="container">
			<div class="c-page-title c-pull-left">
				<h3 class="c-font-uppercase c-font-bold">预约看场</h3>
			</div>
                    ...
                    <div class="c-content-media-1 c-bordered" style="margin-top: 20px;">
                        <form id="reserve_form">
                            ...
                            <ul class="c-content-list-1 c-theme c-separator-dot c-square">
                                ...
                                <li>
                                    预约看场:
                                    <input id="reserve_date" name="reserve_date" class="form-control c-square c-theme input-sm" placeholder="请选择看场日期" data-plugin="datepicker" required="" type="text" style="display: inline; width: auto;" readonly>
                                ...
                                <li>
                                    预计入场: 
                                    <input type="text" id="start_date" name="start_date" class="form-control c-square c-theme input-sm" placeholder="入场日期" data-plugin="datepicker" style="display: inline; width: auto;" readonly>
