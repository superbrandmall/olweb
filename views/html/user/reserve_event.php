	...
	<div class="c-layout-breadcrumbs-1 c-fonts-uppercase c-fonts-bold">
		<div class="container">
			<div class="c-page-title c-pull-left">
				<h3 class="c-font-uppercase c-font-bold"><?= $lang['reserve_reserve_event_showing'] ?></h3>
			</div>
			<ul class="c-page-breadcrumbs c-theme-nav c-pull-right c-fonts-regular">
                ...
                <li><?= $lang['reserve_reserve_event_showing'] ?></li>
			</ul>
		</div>
	</div>
	<!-- END: 标题 -->
                    ...
                    <div class="c-content-media-1 c-bordered" style="margin-top: 20px;">
                        <form id="reserve_form">
                            ...
                            <ul class="c-content-list-1 c-theme c-separator-dot c-square">
                                ...
                                <li>
                                    <?= $lang['reserve_date'] ?>:
                                    <input id="reserve_date" name="reserve_date" class="form-control c-square c-theme input-sm" placeholder="<?= $lang['reserve_please_choose'] ?><?= $lang['reserve_date'] ?>" data-plugin="datepicker" required="" type="text" style="display: inline; width: auto;" readonly>
