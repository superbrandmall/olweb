                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" id="merchant_name" name="merchant_name" class="form-control input-lg c-square" disabled>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control input-lg c-square" id="modality_0" name="modality_0" disabled>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control input-lg c-square" id="modality_1" name="modality_1" disabled>
                                <option value=""><?= $lang['profile_choose'] ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control input-lg c-square" id="modality_2" name="modality_2" disabled>
                                <option value=""><?= $lang['profile_choose'] ?></option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select class="form-control input-lg c-square" id="modality_3" name="modality_3" disabled>
                                <option value=""><?= $lang['profile_choose'] ?></option>
                            </select>
                        </div>
                    </div>
