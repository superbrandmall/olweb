        ...
        <div class="weui-media-box weui-media-box_appmsg" style="background: rgb(245, 245, 245); padding: 0; margin: 0 16px 16px;">
            <div class="weui-media-box__bd">
                <div style="position: relative;">
                    ...
                    <ul class="leasing-areas">
                        <li><a href='javascript: showVR("https://720yun.com/t/97vkOhrq01y?scene_id=57895081");'>VR</a></li>
                        <li><a href="/v2/shop?id=OLSHOP180917000683&type=leasing">查看详情</a></li>
                    </ul>
                </div>
                <div class="weui-cell_select" onclick="window.location='/v2/shop?id=OLSHOP180917000683&type=leasing'" style="position: relative; margin: 10px 0 0 15px;">
                    <p style="font-size: 14px;">7F50</p>
                    <small class="weui-cell__bd" style="margin-right: 40px; display: block; font-size: 12px;">适合非中餐</small>
                </div>
                <div style="margin: 5px 15px 10px;">
                    <span class="weui-mark-rb">租金 ¥15/m<sup>2</sup>/天</span>
        ...
        <div class="weui-media-box weui-media-box_appmsg" style="background: rgb(245, 245, 245); padding: 0; margin: 0 16px 16px;">
            <div class="weui-media-box__bd">
                <div style="position: relative;">
                    ...
                    <ul class="leasing-areas">
                        <li><a href='javascript: showVR("https://720yun.com/t/97vkOhrq01y?scene_id=57895081");'>VR</a></li>
                        <li><a href="/v2/shop?id=OLSHOP181115000004&type=leasing">查看详情</a></li>
                    </ul>
                </div>
                <div class="weui-cell_select" onclick="window.location='/v2/shop?id=OLSHOP181115000004&type=leasing'" style="position: relative; margin: 10px 0 0 15px;">
                    <p style="font-size: 14px;">7F51AB</p>
                    <small class="weui-cell__bd" style="margin-right: 40px; display: block; font-size: 12px;">适合非中餐</small>
                </div>
                <div style="margin: 5px 15px 10px;">
                    <span class="weui-mark-rb">租金 ¥15/m<sup>2</sup>/天</span>
        ...
        <div class="weui-media-box weui-media-box_appmsg" style="background: rgb(245, 245, 245); padding: 0; margin: 0 16px 16px;">
            <div class="weui-media-box__bd">
                <div style="position: relative;">
                    <img onclick='javascript: showGallery("/views/assets/base/img/content/backgrounds/category/chinese_food.jpg");' class="weui-media-box__thumb" src="/views/assets/base/img/content/backgrounds/category/chinese_food.jpg" alt="" style="border-top-left-radius: 10px; border-top-right-radius: 10px;">
                    <ul class="leasing-areas">
                        <li><a href='javascript: showVR("https://720yun.com/t/97vkOhrq01y?scene_id=57895082");'>VR</a></li>
                        <li><a href="/v2/shop?id=OLSHOP181115000005&type=leasing">查看详情</a></li>
                    </ul>
                </div>
                <div class="weui-cell_select" onclick="window.location='/v2/shop?id=OLSHOP181115000005&type=leasing'" style="position: relative; margin: 10px 0 0 15px;">
                    <p style="font-size: 14px;">7F52-53A</p>
                    <small class="weui-cell__bd" style="margin-right: 40px; display: block; font-size: 12px;">适合非中餐</small>
                </div>
                <div style="margin: 5px 15px 10px;">
                    <span class="weui-mark-rb">租金 ¥15/m<sup>2</sup>/天</span>
