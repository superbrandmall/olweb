...
<div class="page__bd" style="padding: 32px 0;">
    <a href="javascript: showVR('https://720yun.com/t/d0vksldepqe?scene_id=43986975');">
        <div class="weui-grid__icon">
            <img src="/views/assets/base/img/content/backgrounds/mall-list/ljz.jpg" alt="" style="border-radius: 10px;">
        </div>
