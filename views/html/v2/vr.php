...
<div class="page__bd" style="margin-top: 9px; padding: 0 16px;">
    <div class="weui-flex" style="text-align: center; height: 100px;">
        <div onclick="javascript: showVR('https://720yun.com/t/d0vksldepqe?scene_id=43986975');" class="weui-flex__item" style="position: relative; margin-right: 16px; background: url(/views/assets/base/img/content/backgrounds/mall01.jpg); background-size: cover; background-position: center">
        ...
        <div onclick="javascript: showVR('https://720yun.com/t/1fvks7dypdh?scene_id=47733921');" class="weui-flex__item" style="position: relative; margin-right: 16px; background: url(/views/assets/base/img/content/backgrounds/mall06.jpg); background-size: cover; background-position: center">
        ...
        <div class="weui-flex__item" style="position: relative; background: url(/views/assets/base/img/content/backgrounds/mall02.jpg); background-size: cover; background-position: center">
    ...
    <div class="weui-flex" style="text-align: center; height: 100px;">
        <div class="weui-flex__item" style="position: relative; margin-right: 16px; background: url(/views/assets/base/img/content/backgrounds/mall03.jpg); background-size: cover; background-position: center">
        ...
        <div class="weui-flex__item" style="position: relative; background: url(/views/assets/base/img/content/backgrounds/mall05.jpg); background-size: cover; background-position: center">
