...
<div class="weui-form__text-area" style="margin: 20px 0;">
    <h2 class="weui-form__title">请填写注册资料以查看合同</h2>
</div>
...
<div class="page__bd">
    <form id="basic" class="weui-form__control-area">
            ...
            <div class="weui-cells weui-cells_form">
                <div class="weui-cell weui-cell_active">
                    ...
                    <div class="weui-cell__bd">
                        <input name="company_name" id="company_name" class="weui-input" required placeholder="填写企业名称"/>
                    </div>
                </div>
                <div class="weui-cell weui-cell_active">
                    <div class="weui-cell__hd errorDiv" id="errorcontainer-uscc"><label class="weui-label">税号*<br>(统一社会信用代码)</label></div>
                    <div class="weui-cell__bd">
                        <input name="uscc" id="uscc" class="weui-input" required placeholder="填写税号"/>
                    </div>
                </div>
                <div class="weui-cell weui-cell_active">
        ...
        <div class="weui-cells__group weui-cells__group_form">
            <div class="weui-cells weui-cells_form">
                <div class="weui-cell weui-cell_active">
                    ...
                    <div class="weui-cell__bd">
                        <input name="mailing_address" id="mailing_address" class="weui-input placeholder" required placeholder=""/>
                    </div>
                </div>
                <div class="weui-cell weui-cell_active">
                    <div class="weui-cell__hd errorDiv" id="errorcontainer-invoice_address"><label class="weui-label">开票地址*</label></div>
                    <div class="weui-cell__bd">
                        <input name="invoice_address" id="invoice_address" class="weui-input placeholder" required placeholder=""/>
                    </div>
                </div>
                <div class="weui-cell weui-cell_active">
                ...
                <div class="weui-cell weui-cell_active">
                    ...
                    <div class="weui-cell__bd">
                        <input name="street_address" id="street_address" class="weui-input placeholder" required placeholder=""/>
                    </div>
                </div>
                <div class="weui-cell weui-cell_active">
                    <div class="weui-cell__hd errorDiv" id="errorcontainer-billing_address"><label class="weui-label">账单地址*</label></div>
                    <div class="weui-cell__bd">
                        <input name="billing_address" id="billing_address" class="weui-input placeholder" required placeholder=""/>
                    </div>
                </div>
                <div class="weui-cell weui-cell_active">
    ...
    <form id="bank" class="weui-form__control-area" style="display: none;">
        <div class="weui-cells__group weui-cells__group_form">
            <div class="weui-cells weui-cells_form">
                <div class="weui-cell weui-cell_active">
                    <div class="weui-cell__hd errorDiv" id="errorcontainer-bank_account"><label class="weui-label">银行卡号*</label></div>
                    <div class="weui-cell__bd">
                        <input name="bank_account" id="bank_account" class="weui-input" required placeholder="填写银行卡号"/>
                    </div>
                </div>
                <div class="weui-cell weui-cell_active">
                    <div class="weui-cell__hd errorDiv" id="errorcontainer-bank_name"><label class="weui-label">开户银行*</label></div>
                    <div class="weui-cell__bd">
                        <input name="bank_name" id="bank_name" class="weui-input placeholder" required />
                    </div>
                </div>
            </div>
        </div>
    ...
    <form id="authorization" class="weui-form__control-area" style="display: none; margin-top: 20px;">
        <div class="weui-cells__group weui-cells__group_form">
            <div class="weui-cells__title"<i class="fa fa-info-circle"></i> 授权人即贵司授权用印人</div>
            <div class="weui-cells weui-cells_form">
                <div class="weui-cell weui-cell_active">
