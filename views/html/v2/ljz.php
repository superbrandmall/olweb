...
<div class="page__bd">
    ...
    <div class="weui-grids">
        <a href="/v2/leasing?f=1&type=leasing" class="weui-grid wow slideInRight" data-wow-offset="300">
            <div class="weui-grid__icon">
                <img src="/views/assets/base/img/content/backgrounds/sbm/Area/1F.jpg" alt="">
            </div>
            <p class="weui-grid__label">国际时尚品牌旗舰店入驻，滨江露天餐酒空间</p>
        </a>
        <a href="/v2/leasing?f=2&type=leasing" class="weui-grid wow slideInRight" data-wow-offset="300">
            <div class="weui-grid__icon">
                <img src="/views/assets/base/img/content/backgrounds/sbm/Area/2F.jpg" alt="">
            </div>
            <p class="weui-grid__label">爸妈宝贝同乐；一站式遛娃好去处！</p>
        </a>
        <a href="/v2/leasing?f=3&type=leasing" class="weui-grid wow slideInRight" data-wow-offset="300">
            <div class="weui-grid__icon">
                <img src="/views/assets/base/img/content/backgrounds/sbm/Area/3F.jpg" alt="">
            </div>
            <p class="weui-grid__label">快时尚、少淑女装搭配潮流彩妆，时髦女生必打卡！</p>
        </a>
        <a href="/v2/leasing?f=4&type=leasing" class="weui-grid wow slideInRight" data-wow-offset="300">
            <div class="weui-grid__icon">
                <img src="/views/assets/base/img/content/backgrounds/sbm/Area/4F.jpg" alt="">
            </div>
            <p class="weui-grid__label">运动、数码旗舰林立；行头、装备一个都不能少！</p>
        </a>
        <a href="/v2/leasing?f=5&type=leasing" class="weui-grid wow slideInRight" data-wow-offset="300">
            <div class="weui-grid__icon">
                <img src="/views/assets/base/img/content/backgrounds/sbm/Area/5F.jpg" alt="">
            </div>
            <p class="weui-grid__label">美食、动漫潮店云集，展览、快闪活动不断</p>
        </a>
        <a href="/v2/leasing?f=6&type=leasing" class="weui-grid wow slideInRight" data-wow-offset="300">
            <div class="weui-grid__icon">
                <img src="/views/assets/base/img/content/backgrounds/sbm/Area/6F.jpg" alt="">
            </div>
            <p class="weui-grid__label">怀旧中式家庭场景，“罍+村”带你追忆地道古早味</p>
        </a>
        <a href="/v2/leasing?f=7&type=leasing" class="weui-grid wow slideInRight" data-wow-offset="300">
            <div class="weui-grid__icon">
                <img src="/views/assets/base/img/content/backgrounds/sbm/Area/7F.jpg" alt="">
            </div>
            <p class="weui-grid__label">造型护理、身材管理，从发丝精致到足尖</p>
        </a>
        <a href="/v2/leasing?f=8&type=leasing" class="weui-grid wow slideInRight" data-wow-offset="300">
            <div class="weui-grid__icon">
                <img src="/views/assets/base/img/content/backgrounds/sbm/Area/8F.jpg" alt="">
            </div>
