    ...
    <section style="padding: 20px 15px 10px; clear: both;">
        <div class="weui-cells page-category-content">
            ...
            <table class="content" style="font-size: 11px;">
                <tbody>
                    <tr>
                        <td style="background: #FEDDB8; color: #333;">履约保证金(含税)</td>
                        <td>¥<span id="deposit"></span></td>
                    </tr>
                    <tr>
                        <td style="background: #FEDDB8; color: #333;">数据采集设备押金</td>
                        <td>¥<span>3,000</span></td>
                    </tr>
                    <tr>
                        <td style="background: #FEDDB8; color: #333;">每月推广费</td>
            ...
            <table class="content">
                <tbody>
                    <tr>
                        <td style="background: #FEDDB8; background: -webkit-linear-gradient(to bottom, #DAB892, #FEDDB8); background: linear-gradient(to bottom, #DAB892, #FEDDB8); color: #333;">首期总计交纳金额</td>
