...
<div class="timeline_btn">
    <i class="fa fa-cog fa-spin fa-fw"></i> 1/5
</div>
...
<div id="timeline">
    <ul>
        <li class="timeline-item">
            ...
            <div class="timeline-item-content"><h4 class="recent">1.介绍</h4>
                <p class="recent">Introduction</p></div>
        </li>
        <li class="timeline-item">
            <div class="timeline-item-color timeline-item-head"></div>
            <div class="timeline-item-tail"></div>
            <div class="timeline-item-content"><h4> 2.选择</h4>
                <p><?php echo $choose; ?></p></div>
        </li>
        <li class="timeline-item">
            <div class="timeline-item-color timeline-item-head"></div>
            <div class="timeline-item-tail"></div>
