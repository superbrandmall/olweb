                    ...
                    <div class="weui-cells weui-cells_form">
                        ...
                        <div class="weui-cell weui-cell_active">
                            ...
                            <div class="weui-cell__bd">
                                ...
                                <div id="errorcontainer-sign_body" class="errorDiv"></div>
                            </div>
                        </div>
                        <div class="weui-cell weui-cell_active">
                        ...
                        <div class="weui-cell weui-cell_active">
                            ...
                            <div class="weui-cell__bd">
                                ...
                                <div id="errorcontainer-event_name" class="errorDiv"></div>
                            </div>
                        </div>
                                ...
                                <div class="weui-uploader">
                                    ...
                                    <div class="weui-uploader__bd">
                                        ...
                                        <div class="weui-uploader__input-box">
                                            ...
                                            <div id="errorcontainer-event_plan" class="errorDiv"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="weui-uploader">
                                    ...
                                    <div class="weui-uploader__bd">
                                        ...
                                        <div class="weui-uploader__input-box">
                                            ...
                                            <div id="errorcontainer-authorization" class="errorDiv"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
