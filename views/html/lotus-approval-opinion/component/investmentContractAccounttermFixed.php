<div class="box box-default hidden-print" id="investmentContractAccounttermFixed">    
    ...
    <div class="box-body" id="newFixed" style="padding: 0; display: none;">
        <div class="col-md-12">
            <div class="box-body">
                <div class="row">
                        ...
                        <div class="fixed-table-container">
                            <div class="fixed-table-body">
                                <table class="table table-striped snipe-table table-responsive">
                                    ...
                                    <tbody id="fixedRent" align="center"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
    ...
    <div class="box-body" id="changeFixed" style="padding: 0; display: none;">
        <div class="col-md-6">
            <h5>变更前</h5>
            <div class="box-body">
                <div class="row">
                    <div class="bootstrap-table">
                        <div class="fixed-table-container">
                            <div class="fixed-table-body">
                                <table class="table table-striped snipe-table table-responsive">
                                    <thead id="assetsListingTable-sticky-header-1">
                                        <tr>
                                            <th>
                                                <div class="th-inner">租金期间</div>
                                                <div class="fht-cell"></div>
                                    ...
                                    <tbody id="fixedRentBefore" align="center"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="bootstrap-table">
                        <div class="fixed-table-container">
                            <div class="fixed-table-body">
                                <table class="table table-striped snipe-table table-responsive">
                                    <thead id="assetsListingTable-sticky-header-2">
                                        <tr>
                                            <th>
                                                <div class="th-inner">租金期间</div>
                                                <div class="fht-cell"></div>
                                    ...
                                    <tbody id="fixedRentAfter" align="center"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
