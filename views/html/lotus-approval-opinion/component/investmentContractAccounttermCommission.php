<div class="box box-default hidden-print" id="investmentContractAccounttermCommission">    
    ...
    <div class="box-body" id="newDeduct" style="padding: 0; display: none;">
        <div class="col-md-12">
            <div class="box-body">
                <div class="row">
                        ...
                        <div class="fixed-table-container">
                            <div class="fixed-table-body">
                                <table class="table table-striped snipe-table table-responsive">
                                    ...
                                    <tbody id="commission" align="center"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
    ...
    <div class="box-body" id="changeDeduct" style="padding: 0; display: none;">
        <div class="col-md-6">
            <h5>变更前</h5>
            <div class="box-body">
                <div class="row">
                        ...
                        <div class="fixed-table-container">
                            <div class="fixed-table-body">
                                <table class="table table-striped snipe-table table-responsive">
                                    ...
                                    <tbody id="commissionBefore" align="center"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="fixed-table-container">
                            <div class="fixed-table-body">
                                <table class="table table-striped snipe-table table-responsive">
                                    ...
                                    <tbody id="commissionAfter" align="center"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
