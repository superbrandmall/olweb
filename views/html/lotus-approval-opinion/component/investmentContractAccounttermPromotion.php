<div class="box box-default hidden-print" id="investmentContractAccounttermPromotion">    
                        ...
                        <div class="fixed-table-container">
                            <div class="fixed-table-body">
                                <table class="table table-striped snipe-table table-responsive">
                                    ...
                                    <tbody id="promotion" align="center"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
    ...
    <div class="box-body" id="changePromotion" style="padding: 0; display: none;">
        <div class="col-md-6">
            <h5>变更前</h5>
            <div class="box-body">
                <div class="row">
                        ...
                        <div class="fixed-table-container">
                            <div class="fixed-table-body">
                                <table class="table table-striped snipe-table table-responsive">
                                    ...
                                    <tbody id="promotionBefore" align="center"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="fixed-table-container">
                            <div class="fixed-table-body">
                                <table class="table table-striped snipe-table table-responsive">
                                    ...
                                    <tbody id="promotionAfter" align="center"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
