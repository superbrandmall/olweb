<div class="box box-default" id="textareapanel" style="page-break-before: always;">    
    <div class="box-header with-border hidden-print">
        <h3 class="box-title">特别事项说明</h3>
    </div>
    <div class="box-body">
        <h5 class="visible-print" style="margin-top: 60px; ">特别事项说明</h5>
        <div style="line-height: 24px;">
            <p id="newRemark" style="display: none;">
                ...
                <span id="newArea"></span>新签
                <span id="newDuration" class="txt"></span>个月，
                <span id="newFixedRent"></span>
                <span id="newCommission"></span>
                <span id="newPropertyMgmt"></span>
                <span id="newPromotion"></span>
                <span id="newTargetSales"></span>
                <span id="newAwardDate"></span>
            ...
            <p id="renewRemark" style="display: none;">
                ...
                <span id="renewBrand"></span>，
                <span id="renewArea"></span>续约
                <span id="renewDuration" class="txt"></span>个月，
                <span id="renewRenewBrandHoldFlag"></span>
                <span id="renewRenewBrandHoldReason"></span>
                <span id="renewFixedRent"></span>
                <span id="renewGrowthRate"></span>
                <span id="renewCommission"></span>
