...
<div style="position: relative; margin-bottom: 20px;">
    ...
    <a href="/v2/ads-ly?type=ads" class="wow fadeInUp" data-wow-delay="1.0s" data-wow-offset="300" style="position: absolute; color: #fff; top: 24%; left: 70%; font-size: 14px;">做广告</a>
</div>
...
<div class="page__bd" style="background: #0C31FA;">
    ...
    <ul class="collapse">
        ...
        <li>
            ...
            <div class="page-category js-categoryInner" style="color: #000;">
