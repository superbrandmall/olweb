...
<div class="weui-btn-area" style="margin-top: 20px;">
    <center>
        <button type="button" class="weui-btn weui-btn_mini bg-gray" onclick="javascript: window.history.back(-1);" style="color: #000;">返回</button>
        <button type="button" class="weui-btn weui-btn_mini bg-red" id="negotiate">谢绝</button>
        <button type="button" class="weui-btn weui-btn_mini weui-btn_primary" id="update_files">更新文件</button>
    </center>
</div>
