...
<div style="position: relative;">
    ...
    <a href="javascript:;" class="wow fadeInUp" data-wow-delay="0.8s" data-wow-offset="300" style="position: absolute; color: #fff; top: 37%; left: 45%; font-size: 14px; font-weight: bold;">办活动</a>
    <a href="/v2/ads?type=ads" class="wow fadeInUp" data-wow-delay="1.0s" data-wow-offset="300" style="position: absolute; color: #fff; top: 24%; left: 70%; font-size: 14px;">做广告</a>
</div>
    ...
    <div class="weui-panel__bd">
        <div class="weui-media-box weui-media-box_appmsg" style="padding: 0; margin: 0 16px 16px; background: #fff;">
            <div class="weui-media-box__bd">
                <div style="position: relative;">
                    <div class="slide" style="background: #0C31FA;">
                        <ul>
                            <li>
                ...
                <div class="weui-cell_select" onclick="window.location='/v2/event?id=OLSHOP180917001126&type=events'" style="position: relative; margin: 10px 0 0 15px;">
                    ...
                    <small class="weui-cell__bd" style="margin-right: 40px; display: block; font-size: 12px;">东方明珠天桥下楼，进入正大广场正门即见</small>
                </div>
                <div style="margin: 5px 15px 10px;">
                    <span class="weui-mark-rb">1F东厅</span>
                    <span class="weui-mark-rb">49m²</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="weui-media-box weui-media-box_appmsg" style="padding: 0; margin: 0 16px 16px; background: #fff;">
            <div class="weui-media-box__bd">
                ...
                <div class="weui-cell_select" onclick="window.location='/v2/event?id=OLSHOP180917001116&type=events'" style="position: relative; margin: 10px 0 0 15px;">
                    ...
                    <small class="weui-cell__bd" style="margin-right: 40px; display: block; font-size: 12px;">临近滨江，180平开阔场地/高空视野，全楼层透视/自然光线多重搭配</small>
                </div>
                <div style="margin: 5px 15px 10px;">
                    <span class="weui-mark-rb">1F西厅</span>
                    <span class="weui-mark-rb">180m²</span>
                </div>
            </div>
        </div>
    </div>
