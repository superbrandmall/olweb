...
<div class="page__bd" style="position: fixed;left: 0;right: 0;bottom: 0;">
    <div class="weui-panel__bd" style="padding: 10px 20px; position: relative; background-color: #e5e5e5; border-radius: 10px; margin-top: -50px; box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.5);-webkit-box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.5);">
        ...
        <a id="ad_shopping_cart" href="javascript:;" style="display: inline-block; font-size: 12px; color: #0C31FA; padding: 5px 0; text-align: center; width: 60px;">
        ...
        <a id="add_ad" href="javascript:;" style="float: right; font-size: 12px; color: #000; text-align: center; width: 80px;">
            <i class="fa fa-plus" aria-hidden="true" style="font-size: 30px; color: #0C31FA; font-weight: bold;"></i><br>
            添加
        </a>
    </div>
</div>
