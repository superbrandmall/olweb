...
<html>
    <head>
        ...
        <link rel="stylesheet" href="/views/assets/base/js/lotus-admin/iCheck/all.css">
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown mall-select">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li>
                                        <a href="javascript: void(0);" class="mall-select text-blue" data-code="SC033">
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    ...
                                    if(isset($_SESSION['lotus_admin_name']) && $_SESSION['lotus_admin_name'] != '管理员') {
                                        echo '<img src="/views/assets/base/img/content/lotus-admin/'.$_SESSION['lotus_admin_login'].'.jpg" class="user-image" alt="'.$_SESSION['lotus_admin_name'].'">';
                                    } else {
                                        echo '<img src="/views/assets/base/img/content/lotus-admin/avatar.png" class="user-image" alt="User Image">';
                                    }
                                    ?>
