        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-md-3 col-sm-6" style="padding-left: 2px;">
                    <select class="select2" id="fixedRentPeriodTypeCode_1" style="width: 100%">
                        <?php 
                        {
                           for($i=1;$i<25;$i++){
    ...
    <div class="box-body">
        ...
        <div class="col-md-3">
            ...
            <div class="col-md-1 col-sm-6" style="padding-top: 6px;">
                <input type="checkbox" id="fixedRentIsOverdueFlag_1" checked>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
        ...
        <div class="col-md-3">
            ...
            <div class="col-md-1 col-sm-6" style="padding-top: 6px;">
                <input type="checkbox" id="fixedRentOverdueInvoiceFlag_1" checked>
            </div>
        </div>
    </div>
</div>