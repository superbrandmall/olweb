<div class="modal fade" id="investment-contract-request-todo" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="bootstrap-table">
                        <div class="fixed-table-container">
                            <div class="fixed-table-body">
                                <table class="table table-striped snipe-table table-responsive" style="font-size: 11px;">
