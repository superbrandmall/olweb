...
if(isset($_SESSION['lotus_admin_name']) && $_SESSION['lotus_admin_name'] == '马俊') {
    $scripts = $scripts .PHP_EOL. '        <script type="text/javascript" src="/views/assets/base/js/lotus-admin/modify-requests-admin.js"></script>'.PHP_EOL;
} else {
    $scripts = $scripts .PHP_EOL. '        <script type="text/javascript" src="/views/assets/base/js/lotus-admin/encrypted/modify-requests.js"></script>'.PHP_EOL;
}
?>
...
<div class="content-wrapper">
    <section class="sub-header" style="height: 250px;">
        ...
        <div class="pull-right">
            ...
            <a href="javascript: void(0);" id="createModify" class="btn btn-primary btn-sm"><i class="fa fa-plus icon-white"></i> <span class="hidden-xs">创建合同变更申请单</span></a>
        </div>
                                                ...
                                                <span class="page-list">
                                                    <span class="btn-group dropdown">
                                                        ...
                                                        <ul class="dropdown-menu" role="menu">
                                                            <li role="menuitem"><a href="/lotus-admin/modify-requests?items=10">10</a></li>
                                                            <li role="menuitem"><a href="/lotus-admin/modify-requests?items=20">20</a></li>
                                                            <li role="menuitem"><a href="/lotus-admin/modify-requests?items=30">30</a></li>
                                                            <li role="menuitem"><a href="/lotus-admin/modify-requests?items=50">50</a></li>
                                                        </ul>
                                                    </span> 
                                                    行每页
                                                </span>
