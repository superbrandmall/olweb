    ...
    <div class="box-body">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-12">
                    <div class="input-group">
                        ...
                        <span class="input-group-addon" style="border-left: none; background: transparent;">m²</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-12">
                    <div class="input-daterange input-group">
                        <input type="text" class="form-control" id="oldDurationStartDate" readonly style="border: 1px solid #ccc; background: #fff; border-radius: 0; border-right: none;" />
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="oldDurationEndDate" readonly style="border: 1px solid #ccc; background: #fff; border-radius: 0; border-right: none;" />
                            <span class="input-group-addon" style="border-left: none; background: transparent;"><i class="fa fa-calendar"></i></span>
                        </div>    
                    </div>
                </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-12">
                    <div class="input-group">
                        <input class="form-control" id="oldRentalFloorTaxEffect" type="text" style="border-right: none;"/>                                      
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-12">
                    <div class="input-group">
                        <input class="form-control" id="oldRentalFloorEffect" type="text" style="border-right: none;" />                                      
                        <span class="input-group-addon" style="border-left: none; background: transparent;">元/m²/天</span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-12">
                    <div class="input-group">
                        <input class="form-control" id="oldCostEffect" type="text" style="border-right: none;" />                                      
                        <span class="input-group-addon" style="border-left: none; background: transparent;">元/m²/天</span>
                    </div>
                </div>
            </div>
