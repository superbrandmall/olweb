<?php
$scripts = $scripts . '<script type="text/javascript" src="/views/assets/base/js/lotus-admin/create-brand-admin.js"></script>';
?>
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            <form id="create-form" class="form-horizontal" role="form" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label for="contact_name_1" class="col-md-3 control-label">联系人 <span class="btn-box-tool-lg">*</span></label>
                                    <div class="col-md-7 col-sm-12 required">
                                ...
                                <div class="form-group">
                                    <label for="contact_phone_1"  class="col-md-3 control-label">联系电话 <span class="btn-box-tool-lg">*</span></label>
                                    <div class="col-md-7 col-sm-12 required">
