<?php
$scripts = $scripts . '<script type="text/javascript" src="/views/assets/base/js/lotus-admin/stores-admin.js"></script>';
?>
...
<div class="content-wrapper">
    <section class="content-header" style="padding-bottom: 30px;">
        ...
        <div class="pull-right">
            <a href="/lotus-admin/create-store" class="btn btn-primary pull-right">
                新建铺位
            </a>
        </div>
    </section>
                                        ...
                                        <div class="fixed-table-container table-no-bordered">
                                            <div class="fixed-table-body">
                                                <table class="table table-striped snipe-table table-responsive table-no-bordered" style="margin-top: 0">
                                                    ...
                                                    <tbody id="storesL" class="hidden-xs"></tbody>
