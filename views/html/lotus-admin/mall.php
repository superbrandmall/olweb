<?php
$scripts = $scripts . '<script type="text/javascript" src="/views/assets/base/js/lotus-admin/mall-admin.js"></script>'.PHP_EOL;
?>
                            ...
                            <div class="box-body">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="mallCode" class="col-md-4 control-label">门店代码</label>
                                    ...
                                    <div class="form-group">
                                        <label for="mallName" class="col-md-4 control-label">门店名称</label>
                                        <div class="col-md-8 col-sm-12 required">
                                    ...
                                    <div class="form-group">
                                        <label for="address" class="col-md-4 control-label">门店地址</label>
                                        <div class="col-md-8 col-sm-12 required">
                                    ...
                                    <div class="form-group">
                                        <label for="uscc" class="col-md-4 control-label">社会信用代码</label>
                                        <div class="col-md-8 col-sm-12 required">
                                    ...
                                    <div class="form-group">
                                        <label for="regAddress" class="col-md-4 control-label">注册地址</label>
                                        <div class="col-md-8 col-sm-12 required">
                                    ...
                                    <div class="form-group">
                                        <label for="bankName" class="col-md-4 control-label">开户银行</label>
                                        <div class="col-md-8 col-sm-12 required">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="cityDistrict" class="col-md-4 control-label">所属区域</label>
                                        <div class="col-md-8 col-sm-12 required">
                                    ...
                                    <div class="form-group">
                                        <label for="deliveryAddress" class="col-md-4 control-label">邮寄地址</label>
                                        <div class="col-md-8 col-sm-12 required">
                                    ...
                                    <div class="form-group">
                                        <label for="mail" class="col-md-4 control-label">联系邮箱</label>
                                        <div class="col-md-8 col-sm-12 required">
                                    ...
                                    <div class="form-group">
                                        <label for="building" class="col-md-4 control-label">楼宇数量</label>
                                        <div class="col-md-8 col-sm-12 required">
                                    ...
                                    <div class="form-group">
                                        <label for="startDate" class="col-md-4 control-label">合同开始日</label>
                                        <div class="col-md-8 col-sm-12 required">
                                    ...
                                    <div class="form-group">
                                        <label for="endDate" class="col-md-4 control-label">合同终止日</label>
                                        <div class="col-md-8 col-sm-12 required">
