...
<div class="content-wrapper store-detail">
    <form id="create-form" class="form-horizontal" role="form" enctype="multipart/form-data">
        <section class="sub-header" style="height: 90px;">
            <div class="pull-left">
                <a href="/lotus-admin/stores" class="btn btn-link"><i class="fa fa-angle-left"></i> 返回列表</a>
            </div>
            <h4>
            ...
            <div class="pull-right">
                ...
                <button type="submit" class="btn btn-success btn-sm" id="saveDraft" style="display: none;"><i class="fa fa-check icon-white"></i> <span class="hidden-xs">提交保存</span></button>
            </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-default" id="storePropertyInfo">    
                            ...
                            <div class="box-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="unitArea" class="col-md-4 control-label">租赁面积 <span class="btn-box-tool-lg">*</span></label>
                                        <div class="col-md-8 col-sm-12">
                                            <div class="input-group">
                                                <input class="form-control money" id="unitArea" name="unitArea" type="text" style="border: 1px solid #ccc; background: #fff; border-right: none;" required />                                                
