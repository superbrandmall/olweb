<div class="box box-default" id="investmentContractAccounttermPropertyMgmt">    
    <div class="box-header with-border">
        ...
        <div class="pull-right" style="margin-right: 30px;">
            <button type="button" class="btn btn-info btn-xs" onclick="javascript: saveContractPropertyMgmt();"><i class="fa fa-save icon-white"></i> <span class="hidden-xs">保存物业管理费</span></button>
        </div>
        <div class="pull-right" style="margin-right: 10px;">
            <a href="javascript:void(0);" onClick="addRowInvestmentContractAccounttermPropertyMgmt()">
    ...
    <div class="box-body">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="col-md-1 col-sm-6" style="padding-top: 6px;">
                    <input type="checkbox" id="propertyMgmtIsOverdueFlag_1">
                </div>
            </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="col-md-1 col-sm-6" style="padding-top: 6px;">
                    <input type="checkbox" id="propertyMgmtOverdueInvoiceFlag_1">
                </div>
            </div>
        </div>
    </div>
