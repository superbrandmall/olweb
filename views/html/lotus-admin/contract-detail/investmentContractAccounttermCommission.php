<div class="box box-default" id="investmentContractAccounttermCommission" style="display: none;">    
    <div class="box-header with-border">
        ...
        <div class="pull-right" style="margin-right: 30px;">
            <button type="button" class="btn btn-info btn-xs" onclick="javascript: saveContractCommission();"><i class="fa fa-save icon-white"></i> <span class="hidden-xs">保存提成租金</span></button>
        </div>
        <div class="pull-right" style="margin-right: 10px;">
            <a href="javascript:void(0);" onClick="addRowInvestmentContractAccounttermCommission()">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-12">
                    <select class="select2" id="commissionSalesType_1" style="width: 100%;">
    ...
    <div class="box-body">
        ...
        <div class="col-md-3">
            ...
            <div class="col-md-1 col-sm-6" style="padding-top: 6px;">
                <input type="checkbox" id="commissionIsOverdueFlag_1">
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
        ...
        <div class="col-md-3">
            ...
            <div class="col-md-1 col-sm-6" style="padding-top: 6px;">
                <input type="checkbox" id="commissionOverdueInvoiceFlag_1">
            </div>
        </div>
    </div>
</div>