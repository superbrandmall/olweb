<div class="box box-default" id="investmentContractModel">
    ...
    <div class="box-body">
        ...
        <div class="col-md-4">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label">审图费</label>
                <div class="col-md-8 col-sm-12">
                    <div class="input-group">
                        <input class="form-control money" id="graphFee" type="text" style="border: none;" readonly />                                                
                        <span class="input-group-addon" style="border: 0 none; background: #eee;">元</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-4">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-12">
                    <input class="form-control" id="contractName2" type="text" />
                </div>
            </div>
            <div class="form-group">
