...
<aside class="main-sidebar">
    <section class="sidebar">
        <ul class="sidebar-menu">
            ...
            <li class="<?php if (isset($_GET['p']) && $_GET['p'] == 'lotus-admin/stores' || $_GET['p'] == 'lotus-admin/create-store' || $_GET['p'] == 'lotus-admin/store-detail' || $_GET['p'] == 'lotus-admin/store-contract' || $_GET['p'] == 'lotus-admin/store-budget' ||  
                ...
                <ul class="treeview-menu">
                    <li class="<?php if (isset($_GET['p']) && $_GET['p'] == 'lotus-admin/stores' || $_GET['p'] == 'lotus-admin/create-store' || $_GET['p'] == 'lotus-admin/store-detail' || $_GET['p'] == 'lotus-admin/store-contract' || $_GET['p'] == 'lotus-admin/store-budget') { echo 'active'; }?>"><a href="/lotus-admin/stores?items=20">物业资源</a></li>
