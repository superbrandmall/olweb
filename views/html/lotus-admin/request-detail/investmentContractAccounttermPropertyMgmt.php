<div class="box box-default" id="investmentContractAccounttermPropertyMgmt">    
    <div class="box-header with-border">
        ...
        <div class="pull-right" style="margin-right: 40px;">
            <a href="javascript:void(0);" onClick="addRowInvestmentContractAccounttermPropertyMgmt()" style="margin-right: 10px;">
    ...
    <div class="box-body">
        ...
        <div class="col-md-12">
            ...
            <a href="javascript: void(0);" onclick="termsModalToggle('propertyMgmt');" style="font-size: 14px; margin: 0 5px 0 10px; vertical-align: super;">查看账款明细</a>
            <h5 style="display: inline-block; vertical-align: super">|</h5>
            <a href="javascript: void(0);" id="propertyMgmtBudgetModalLink" onclick="budgetModalToggle('B021');" style="font-size: 14px; margin-left: 5px; vertical-align: super;">查看预算明细</a>
        </div>
    </div>
    <div class="box-body">
        <div class="col-md-12">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-md-5 col-sm-6" style="padding-right: 2px;">
                    <select class="select2" id="propertyMgmtPeriodType_1" style="width: 100%">
    ...
    <div class="box-body">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="col-md-1 col-sm-6" style="padding-top: 6px;">
                    <input type="checkbox" id="propertyMgmtIsOverdueFlag_1" checked>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            ...
            <div class="form-group">
                ...
                <div class="col-md-7 col-sm-12 required">
                    <div class="input-group">
                        <input class="form-control" id="propertyMgmtOverdueRate_1" type="text" style="border-right: none;" value="1" />
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="col-md-1 col-sm-6" style="padding-top: 6px;">
                    <input type="checkbox" id="propertyMgmtOverdueInvoiceFlag_1" checked>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="box-body">
        <div class="col-md-12">
            <h5 style="display: inline-block;">
                年度商场服务费
                <img src="/views/assets/base/img/content/lotus-admin/new.gif" style="vertical-align: top;">
            </h5>
            <div class="pull-right" style="margin-top: 15px;">
                <a href="javascript:void(0);" onclick="addRowInvestmentContractAccounttermPropertyFeeYear()" style="margin-top: 11px;">
                    <i class="fa fa-plus-circle" style="color: #84CC3D; font-size: 16px; vertical-align: bottom;"></i> 增加行
                </a>
            </div>
        </div>
                                ...
                                <table class="table table-striped snipe-table table-responsive">
                                    <thead id="assetsListingTable-sticky-header">
                                        <tr>
                                            ...
                                            <th>
                                                <div class="th-inner">此段期间总金额(去税) <span class="btn-box-tool-lg">*</span></div>
                                                <div class="fht-cell"></div>
                                            </th>
                                            <th>
                                                <div class="th-inner">此段期间总金额(含税) <span class="btn-box-tool-lg">*</span></div>
                                                <div class="fht-cell"></div>
                                            </th>
                                            <th>
                                                <div class="th-inner">税率 <span class="btn-box-tool-lg">*</span></div>
                                    ...
                                    <tbody id="propertyFeeYear"></tbody>
                                </table>
                            </div>
                        </div>
                    </div>
