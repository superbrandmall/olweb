<div class="box box-default" id="investmentContractAccounttermPromotion">    
    <div class="box-header with-border">
        ...
        <div class="pull-right" style="margin-right: 40px;">
            <a href="javascript:void(0);" onClick="addRowInvestmentContractAccounttermPromotion()" style="margin-right: 10px;">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-md-5 col-sm-6" style="padding-right: 2px;">
                    <select class="select2" id="promotionPeriodType_1" style="width: 100%" disabled>
                        <option value="1" selected>自然月</option>
                        <option value="2">合同月</option>
                    </select>
                </div>
                <div class="col-md-3 col-sm-6" style="padding-left: 2px;">
                    <select class="select2" id="promotionSettleDay_1" style="width: 100%" disabled>
                        <?php 
                        {
                           for($i=1;$i<=31;$i++){
    ...
    <div class="box-body">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="col-md-1 col-sm-6" style="padding-top: 6px;">
                    <input type="checkbox" id="promotionIsOverdueFlag_1" checked disabled>
                </div>
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-12">
                    <select class="select2" id="promotionOverdueTaxRate_1" style="width: 100%" disabled>
            ...
            <div class="form-group">
                ...
                <div class="col-md-7 col-sm-12 required">
                    <div class="input-group">
                        <input class="form-control" id="promotionOverdueRate_1" type="text" style="border-right: none;" value="1" disabled />
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <div class="col-md-1 col-sm-6" style="padding-top: 6px;">
                    <input type="checkbox" id="promotionOverdueInvoiceFlag_1" checked disabled>
                </div>
            </div>
        </div>
    </div>
