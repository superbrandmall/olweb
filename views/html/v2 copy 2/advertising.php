...
<div class="page__hd" style="display: inline-block; width: 100%; background-color: #bba585; margin-top: -7px;">
    <div class="weui-cell weui-cell_select">
        <div class="weui-cell__bd">
            <a href="javascript:" class="weui-select" id="showFloorPicker" style="display: block; width: inherit; color: #514026; font-size: 12px; overflow: hidden; vertical-align: bottom; white-space: nowrap; text-overflow: ellipsis;">请选择楼层</a>
        </div>
    </div>
</div>
