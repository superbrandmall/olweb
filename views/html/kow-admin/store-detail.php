...
if(isset($_SESSION['lotus_admin_name']) && $_SESSION['lotus_admin_name'] == '马俊') {
    $scripts = $scripts .PHP_EOL. '        <script type="text/javascript" src="/views/assets/base/js/kow-admin/store-detail-admin.js?t='.date("Y-m-d").'"></script>'.PHP_EOL;
} else {
    $scripts = $scripts .PHP_EOL. '        <script type="text/javascript" src="/views/assets/base/js/kow-admin/store-detail-admin.js?t='.date("Y-m-d").'"></script>'.PHP_EOL;
}
?>
...
<div class="content-wrapper create-store">
    <form id="create-form" class="form-horizontal" role="form" enctype="multipart/form-data">
        <section class="sub-header" style="height: 90px;">
            <h4>
                <span class="badge badge-success" id="shopStatus" style="vertical-align: top;"></span> <span class="badge badge-success" id="state" style="vertical-align: top;"></span> <b id="unitName2"></b>[<b id="unitCode2"></b>]
            </h4>
                            ...
                            <div class="box-body">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-12 required">
                                            <input class="form-control" type="text" id="unitCode" name="unitCode" placeholder="如:01FC001" readonly>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-12 required">
                                            <select class="select2" id="unitType" style="width: 100%" disabled></select>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-8 col-sm-12 required">
                                            <select class="select2" id="floorName" name="floorName" style="width: 100%" disabled>
