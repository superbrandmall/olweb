    ...
    <div class="box-body">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-12 required">
                    <select class="select2" id="brandName" style="width: 100%" disabled>
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-12 required">
                    <div class="input-group">
                        <input class="form-control" id="area" placeholder="请选择铺位" type="text" style="border-right: none;" readonly />                                                
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-12 required">
                    <select class="select2" id="paymentMode" style="width: 100%">
                        <option value="M" selected="">月付</option>
                        <option value="Q">季付</option>
                    </select>
                </div>
            </div>
            <div class="form-group">
