...
if(isset($_SESSION['lotus_admin_name']) && $_SESSION['lotus_admin_name'] == '马俊') {
    $scripts = $scripts .PHP_EOL. '        <script type="text/javascript" src="/views/assets/base/js/kow-admin/request-detail-admin.js?t='.date("Y-m-d").'"></script>'.PHP_EOL
            ...
            <div class="box-header" style="background-color: #f6f0b2; margin-top: -6px;">
                <div class="pull-left">
                    <ol class="breadcrumb" style="margin-bottom: 0; padding-left: 0;">
                        <li><a href="/kow-admin/request-summary?id=<?= $id; ?>">单据概要</a></li>
