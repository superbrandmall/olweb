...
<div class="c-layout-page">
    ...
    <footer class="c-layout-footer c-layout-footer-3" style="background-color: #2F353B; margin-bottom: 0;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="c-container">
                            <img class="img-responsive" src="/views/assets/base/img/content/mall/ozone/join_us.jpg" alt="" />
                        </div>
                    </div>
                    <div class="col-md-4">
